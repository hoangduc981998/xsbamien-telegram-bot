...
def format_lo_2_so_streaks(streaks_data: dict, province_name: str = "") -> str:
    """
    Format lô 2 số streak analysis - Số về liên tiếp
    
    Args:
        streaks_data: Dict with current_streaks and max_streaks
        province_name: Province name
...
def format_lo_3_so_streaks(streaks_data: dict, province_name: str = "") -> str:
    """
    Format lô 3 số streak analysis - Số về liên tiếp
